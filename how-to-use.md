...
2. [STDIO режим](#stdio-режим)
3. [HTTP режим](#http-режим)
4. [Интеграция с Gemini CLI](#интеграция-с-gemini-cli)
...
1. **Клонирование/скачивание файлов**
   ...
   mkdir C:\MCP-PowerShell-Server
   cd C:\MCP-PowerShell-Server
   
   # Разместите все .ps1 файлы в этой директории
   ```
